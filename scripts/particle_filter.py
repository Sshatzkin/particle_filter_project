...
def movement_model(self, delta_x, delta_y, curr_yaw, old_yaw):
        ...
        for particle in self.particle_cloud:
            ...
            randPosition = Point(uniform(-0.001, 0.001) + particle.pose.position.x, uniform(-0.001, 0.001) + particle.pose.position.y, 0)
            randomYaw = uniform(-0.001, 0.001) * 2 *math.pi + get_yaw_from_pose(particle.pose)   
